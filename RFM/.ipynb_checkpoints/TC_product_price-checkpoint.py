...
# product = soup.select_one("main > div > div > div.grid-uniform.grid-link__container > div:nth-child(1) > div > a")
# # print(product)
...
for product in soup.select("div.grid-link"):
    name = product.select_one(".grid-link__title").text.strip()
